...
OrdosStarportTypes =
{
	EarlyGame =  { "trike.mg.starport", "trike.mg.starport", "quad.rocket.starport", "combat_tank_o.starport", "combat_tank_o.starport", "siege_tank.starport" },
	LateGame =  { "trike.mg.starport", "quad.rocket.starport", "combat_tank_o.starport", "siege_tank.starport", "missile_tank.starport", "missile_tank.starport" }
}
