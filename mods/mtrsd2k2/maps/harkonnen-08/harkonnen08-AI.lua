...
OrdosStarportTypes =
{
	EarlyGame = { "trike.mg.starport", "trike.mg.starport", "quad.rocket.starport", "combat_tank_o.starport" },
	LateGame = { "trike.mg.starport", "trike.mg.starport", "quad.rocket.starport", "combat_tank_o.starport", "combat_tank_o.starport", "siege_tank.starport", "missile_tank.starport" }
}
...
{
	EarlyGame = { "trike.mg.starport", "trike.mg.starport", "quad.rocket.starport", "combat_tank_a.starport", "combat_tank_a.starport" },
	LateGame = { "trike.mg.starport", "quad.rocket.starport", "combat_tank_a.starport", "combat_tank_a.starport", "siege_tank.starport", "missile_tank.starport" }
}
...
ActivateAI = function()
	...
	Trigger.AfterDelay(InitialProductionDelay["AtreidesEnemy"][Difficulty], function ()
		...
		ProduceUnits(AtreidesEnemy, AHiTechFactory, delay, aircraftToBuildAtreides, AttackGroupSize[Difficulty], attackThresholdSize)
	end)

	Trigger.AfterDelay(InitialProductionDelay["MercenaryEnemy"][Difficulty], function ()
