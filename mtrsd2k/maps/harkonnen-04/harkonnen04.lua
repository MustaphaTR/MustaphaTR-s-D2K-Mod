Base = 
{
	Atreides = { AConyard, AOutpost, ARefinery, AHeavyFactory, ALightFactory, AGunt1, AGunt2, ABarracks, ASilo, APower1, APower2, APower3, APower4, APower5, APower6, AMGt1, AMGt2 },
	Fremen = { FGunt1, FGunt2, FMGt1, FMGt2 }
}
...
InitObjectives = function()
	...
	KillHarkonnen = atreides.AddPrimaryObjective("Kill all Atreides units.")
